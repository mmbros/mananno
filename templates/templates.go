...
func (t templateEnum) Files() []string {
	var (
		// files paths
		files = [...]string{"partials/_header.tmpl", "partials/_footer.tmpl", "arenavision/schedule.tmpl", "ilcorsaronero/_base.tmpl", "ilcorsaronero/index.tmpl", "test/transmission.tmpl"}
		// template-index to array of file-index
		ti2afi = [...][]uint8{
			{0, 1, 2}, // av_schedule
			{3, 4},    // corsaro
			{0, 1, 5}, // test_transmission
		}
	)
