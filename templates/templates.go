...
func (t templateEnum) Files() []string {
	var (
		// files paths
		files = [...]string{"partials/_header.tmpl", "partials/_footer.tmpl", "arenavision/schedule.tmpl"}
